...
void res()
{
    ...
    fstream f1, f2;
    time_t t;
    f1.open("t.txt", ios::in | ios::out);
    f2.open("p.txt", ios::in | ios::out | ios::app);
    int ch;
    b.getresdet();
...
void cancell()
{
    ...
    fstream f1, f2, f3;
    f1.open("t.txt",ios::in|ios::out);
    f2.open("p.txt",ios::in|ios::out);
    f3.open("cn.txt",ios::in|ios::out);
	...
	do
	{
		...
		switch(ch)
		{
			case 1:
				...
				break;
			case 2:
				f.open("id.txt",ios::in|ios::out|ios::app);
				a.getid();
				f.write((char *) & a,sizeof(a));
				f.close();
				break;
